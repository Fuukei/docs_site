            ...
            sidebar: [
              ...
              { text: 'Theme Options',
                items: [
                  ...
                  { text: 'Global Options', link: '/en/Sakurairo/Global/' },
                  { text: 'Homepage Options', link: '/en/Sakurairo/Homepage/' },
                  { text: 'Page Options', link: '/en/Sakurairo/Pages/' },
                  { text: 'Other Options', link: '/en/Sakurairo/Others/' },
