...
:::
::: details 我的服务器在国内，默认更新源无法检测更新怎么办？ 
在使用升级功能前，请手动前往主题设置，关于主题中切换更新源为除Github以外的其他选项即可
:::
::: details 我使用的浏览器访问启用本主题的网站 出现了问题（按钮失效/无法正常显示等） 是主题问题吗？ 
...
::: details 我设置的图片、自定义字体等资源没有生效怎么办？
...
:::
::: details 文章卡片的预览图片怎么设置，为什么都是随机图片？
在文章的编辑页面这边可以进行更改。
![image](/shots/article_image.png)
:::
::: details 我无法更新文章、无法发布文章、无法更改设置怎么办？
