...
- Logo 字体（可选）
- 在`字体名称`里填写字体名称，如何获取找到字体名称？以文本方式打开[上面](/Settings/#%E5%BC%95%E7%94%A8%E5%A4%96%E9%83%A8%E5%AD%97%E4%BD%93)生成 web 字体时的`css格式的文件`，`font-family:`引号后面里就是字体名。（注意不要将引号一起填入）
