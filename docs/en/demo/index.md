...
If you're already using this theme, feel free to visit the [Discussion Board](https://github.com/Fuukei/Sakurairo_Wiki/discussions/) to find the current month's thread and share your site. Members of the Fuukei team will review it, and if it meets the criteria, it will be added to the showcase.
-->
<div class="Demo has-sidebar">
<div class="container-2">
<div class="content-2">
<div class="vp-doc content-container-2">
<h1>Blogs Using This Theme</h1>
<p>If you're already using this theme, feel free to visit the <a href="https://github.com/Fuukei/docs_site/discussions/1" target="_blank">Discussion Board</a> and share your site. Members of the Fuukei team will review it, and if it meets the criteria, it will be added to the showcase.</p>
<div class="links">
